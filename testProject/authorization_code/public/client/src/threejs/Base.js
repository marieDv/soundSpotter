/**
 * BASE
 * basic Three.js logic and model + mapping of the genres
 **/
...
class Base extends Component {
    ...
    /**
     * create the p elements that contain the genre information
     **/
    createText(key, size, secUser) {
        let fontSize = 3 + (size[key] * 3);
        let text2 = document.createElement('span');
        if (!secUser) {
            text2.classList.add("genre");
        } else {
            text2.classList.add("genreTwo");
        }
    ...
    componentDidUpdate() {
        if (this.props.setTheme) {
            if (this.props.setTheme === "rapgod") {
                ...
                if (bgSphereTwo) {
                    bgSphereTwo.material.color.setHex(0x191919);
                }
            }
            if (this.props.setTheme === "indiegold") {
                ...
                if (bgSphereTwo) {
                    bgSphereTwo.material.color.setHex(0x7D4FE9);
                }
            }
            if (this.props.setTheme === "summervibes") {
                ...
                if (bgSphereTwo) {
                    bgSphereTwo.material.color.setHex(0x00D6FD);
                }
            }
        }
    ...
    /**
     * map the text elements to the relating parts of the sphere
     **/
    mapSpheres(group, bgSphere) {
        ...
        if (group.children.length > 1) {
            ...
            /**
             * MAP GENRE-SPHERES TO MAIN-SPHERE
             **/
    ...
    /**
     * creates little spheres that are then mapped to the main model
     * Size depends on the popularity of the genre
     **/
